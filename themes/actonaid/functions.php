...
// Hooks
add_action('wp_enqueue_scripts', 'aa_enqueue'); // Frontend styles
add_action('after_setup_theme', 'aa_editor_styles'); // Editor global styles
add_action('admin_enqueue_scripts', 'aa_enqueue_editor_assets'); // Load Google Fonts in the editor
